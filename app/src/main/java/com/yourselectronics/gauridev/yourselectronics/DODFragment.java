...
public class DODFragment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_dod, container, false);
        ...
        mRC_View.setLayoutManager(gridLayoutManager);
    ...
    private void setUpSlider(final SliderAdapter sliderAdapter) {
        DatabaseReference ref = mRootRef.child("banners/deals_of_the_day/slider_top");
