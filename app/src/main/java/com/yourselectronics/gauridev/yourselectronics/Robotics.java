...
public class Robotics extends Fragment {
    private View view;
    private RecyclerView mRobotRCView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRobotRCView = view.findViewById(R.id.robotics_rc_view);
        mRobotRCView.setLayoutManager(new GridLayoutManager(getContext(), 2));
        mRobotRCView.addItemDecoration(new GridSpacingItemDecoration(2,20,true));
        showCompRcView();
    ...
    private void showCompRcView() {
        ...
        mRobotRCView.setAdapter(recyclerAdapter);
    }
